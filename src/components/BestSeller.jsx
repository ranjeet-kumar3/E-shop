  ...
  return (
    <div className='my-10'>
      <div className='text-center text-3xl py-8'>
        ...
        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Odio ducimus esse ipsum nemo libero mollitia veniam quas at est eum quis, ea vero iusto dolorem 
        </p>
      </div>
